...
COUNTRY_CODE_MAP = {
    ...
    "ethiopia": "ET", "kenya": "KE", "paraguay": "PY", "china": "CN", "india": "IN", "north korea": "KP", "south korea": "KR",
...
COUNTRY_NAME_ALIASES = {
    "ethiopian": "Ethiopia", "kenyan": "Kenya", "paraguayan": "Paraguay", "chinese": "China", "indian": "India",
    "korean": "South Korea", "north korean": "North Korea", "thai": "Thailand", "japanese": "Japan",
...
def country_from_match(match: dict[str, Any]) -> str:
    ...
    for obj in (match, comp, cat if isinstance(cat, dict) else {}):
        if not isinstance(obj, dict):
            continue
        for key in ("countryName", "country_name", "country", "name"):
            value = str(obj.get(key) or "").strip()
            if value and not _is_generic_region(value):
                return value
