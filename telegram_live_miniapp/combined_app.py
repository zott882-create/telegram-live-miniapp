...
PREDICTION_SCAN_STATE_VERSION = "five-minute-multi-market-v2"
...
PREDICTION_ODDS_POLICY = "lowest-bookmaker-outcome150to350-plus-total150to300-v5"
...
def _prediction_evaluate_fixture(
    ...
    *,
    ...
    total_ready = bool(_prediction_total_parts(total_code))
    if total_ready:
        market_states['total'] = {
            'status': 'awaiting_odd',
