...
def _recalculate(date_text: str, rows: list[dict[str, Any]], warnings: list[str] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "market_policy": "All Scores24 markets are public",
        "league_policy": "All Scores24 football leagues are public; grouped by league in the interface",
        ...
        "request_policy": "scores24-graphql-all-leagues-public-grouped-v10",
        "feed": rows,
        "errors": {},
