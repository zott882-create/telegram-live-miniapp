...
LAST_GOOD_LIVE_TTL_SECONDS = int(os.environ.get("LAST_GOOD_LIVE_TTL_SECONDS", "1800"))
...
LIVE_CACHE_SECONDS = max(55.0, float(os.environ.get("LIVE_CACHE_SECONDS", "60")))
...
LIVE_BACKGROUND_REFRESH_SECONDS = max(30.0, float(os.environ.get("LIVE_BACKGROUND_REFRESH_SECONDS", "30")))
...
def load_live_payload(force: bool = False, sport: str = "football") -> dict[str, Any]:
    ...
    # A forced refresh is intentionally synchronous. A normal cold request is
    # synchronous only when memory, Redis and last-good have no usable snapshot.
...
def main() -> None:
    ...
    print("=" * 72)
    print("Telegram Football Live Mini App — v10.41 Notifications + Pressure Fix")
