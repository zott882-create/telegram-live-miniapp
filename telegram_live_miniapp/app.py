...
COUNTRY_NAME_ALIASES = {
    ...
    # v6: extra aliases — these are very common in IGScore league names
    ...
    try:
        ...
        for m in matches:
            ...
            if mid in prev_scores:
                ...
                # First time we see this match — backfill goal markers for the
                # current score so the timeline isn't empty if we joined late.
