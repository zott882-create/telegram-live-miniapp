...
def sportscore_team_payload(match_id_value: str, side: str) -> dict[str, Any]:
    ...
    payload = sportscore_provider.team_detail(team_slug, team_name)
...
def sportscore_team_direct_payload(team_id_value: str, team_name: str = "", competition_path: str = "") -> dict[str, Any]:
    ...
    payload = sportscore_provider.team_detail(team_slug, str(team_name or "").strip())
    if not payload.get("ok"):
        return payload
    team = dict(payload.get("team") or {})
    team["id"] = team_slug
    ...
    def do_GET(self) -> None:
        try:
            ...
            if path == "/api/team":
                ...
                if team_id_value:
                    return json_response(self, sportscore_team_direct_payload(team_id_value, team_name_value, competition_path_value))
                if not mid:
...
def main() -> None:
    ...
    print("=" * 72)
    print("Telegram Multi-Sport Mini App — v10.15 SportScore")
