...
FINISHED_MATCH_GRACE_SECONDS = int(os.environ.get("FINISHED_MATCH_GRACE_SECONDS", str(int(max(0.0, MATCH_RETENTION_HOURS) * 3600))))
...
def _enqueue_telegram_delivery(chat_id: str | int, key: str, text_msg: str, link: str = "", legacy_keys: set[str] | None = None) -> bool:
    """Queue a Telegram send without performing network I/O under _notify_lock."""
    ...
    while True:
        ...
        try:
            ...
            with _notify_lock:
                ...
                if not isinstance(sub, dict):
                    continue
                # Remove this item from pending retry storage; it was attempted now.
            ...
            try:
                ...
                pass
            # Keep well below Telegram's global limits and avoid bursts.
            time.sleep(0.05)


def start_telegram_send_workers() -> None:
    global _telegram_queue_started
...
def main() -> None:
    ...
    print("=" * 72)
    print("Telegram Live Matches Mini App — v9.77 performance cleanup")
