...
def detail(slug: str, force: bool = False, expected_match: dict[str, Any] | None = None, sport: str = "football") -> dict[str, Any]:
    ...
    def load():
        ...
        return {
            ...
            "prematch_odds": (expected.get("prematch_odds") if isinstance(expected, dict) and isinstance(expected.get("prematch_odds"), dict) else (expected.get("odds") if isinstance(expected, dict) and isinstance(expected.get("odds"), dict) else {})),
            "opening_odds": (expected.get("opening_odds") if isinstance(expected, dict) and isinstance(expected.get("opening_odds"), dict) else (expected.get("odds") if isinstance(expected, dict) and isinstance(expected.get("odds"), dict) else {})),
